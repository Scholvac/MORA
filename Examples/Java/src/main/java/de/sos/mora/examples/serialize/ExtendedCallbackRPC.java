...
public class ExtendedCallbackRPC {
	
	//////////////////////////	IFace	////////////////////////////
	public interface IFace {
		public void extendedEcho(float value);
	}
	...
	////////////////////////// Internal Stuff ////////////////////////////
	public static final String			TYPE_IDENTIFIER = "EXTENDEDCALLBACK";
	...
	public static class Proxy extends IMoraProxy<IFace> implements IFace {
		...
		public String getTypeIdentifier() { return TYPE_IDENTIFIER; }
			...
			private static class RemoteCall_ExtendedEcho_FLOAT_ extends RemoteMethodCall<Void> {
				private final float mValue;
	
				public RemoteCall_ExtendedEcho_FLOAT_(Communicator c, RemoteMethod rm, float value) {
					super(c, rm);
					mValue = value;
				}
			...
			public CompletableFuture<Void> async_extendedEcho(float value)  throws MoraException {
				final int methodIndex = 0;
				if (mRemoteMethods[methodIndex] == null)
					mRemoteMethods[methodIndex] = createRemoteMethod("ExtendedEcho_FLOAT_");
				RemoteCall_ExtendedEcho_FLOAT_ call = new RemoteCall_ExtendedEcho_FLOAT_(getCommunicator(), mRemoteMethods[methodIndex], value );
				return call.invoke();
			}
			...
			public void extendedEcho(float value){
				try{
					CompletableFuture<Void> future = async_extendedEcho(value);
	...
	public static class Adapter extends IMoraAdapter<IFace> implements IFace {
		...
		static {
			...
			sMethods.put("ExtendedEcho_FLOAT_", new ExtendedEcho_FLOAT_Invoker());
		}
		...
		private static class ExtendedEcho_FLOAT_Invoker implements IMethodInvokation<IFace> {
			
			@Override
			public void invoke(IFace delegate, IMoraInputStream is, IMoraOutputStream os, Communicator communicator) throws IOException {
				final float value = is.readFloat();
				delegate.extendedEcho(value);
			}
		}
	}
}
