...
public class CppPlainGenerator extends AbstractGenerator {
  ...
  public void generateSource(final Model m, final IFileSystemAccess2 fsa) {
    ...
    String _firstUpper = StringExtensions.toFirstUpper(m.getName());
    String _plus = ("src/" + _firstUpper);
    final String sourceFileName = (_plus + "Types.cpp");
    String _firstUpper_1 = StringExtensions.toFirstUpper(m.getName());
    String _plus_1 = (_firstUpper_1 + "Types.h");
    CharSequence _importBlock = this._cppTypeUtil.getImportBlock(QualifiedName.create(_plus_1));
      ...
      if (_equals_2) {
        ...
        _builder.newLine();
        {
          ...
          for(final Interface s_2 : _iterable_3) {
            ...
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("typedef std::shared_ptr<");
  ...
  public CharSequence ProxyHeader(final Interface iface) {
    ...
    String _iFaceName = this._cppTypeUtil.getIFaceName(iface);
    _builder.append(_iFaceName);
    _builder.append(", public ::mora::IMoraProxy {");
    _builder.newLineIfNotEmpty();
    _builder.append("public:");
    _builder.newLine();
    _builder.append("\t");
  ...
  public CharSequence proxyImpl(final Interface i) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append(":\t::mora::IMoraProxy(communicator, remoteObject)");
    _builder.newLine();
    _builder.append("{");
    _builder.newLine();
    _builder.append("}");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("::mora::IMoraProxyPtr ptr = communicator->getProxy(quid);");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    {
      ...
      for(final Method m_1 : _methods_1) {
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.append("mMethodCall = mCommunicator->createCall(mTargetMethod, mCommunicator->generateShortMagic());");
        _builder.newLine();
        {
              ...
              for(final Parameter p_5 : _parameters_5) {
                {
                  ...
                  if (_isPrim) {
                    _builder.append("\t\t");
                    _builder.append("mMethodCall->stream << _");
                    ...
                    if (_isEnum) {
                      ...
                      _builder.append(", mMethodCall->stream);");
                      _builder.newLineIfNotEmpty();
                    } else {
                      ...
                      if (_isProxy) {
                        ...
                        _builder.append(", mMethodCall->stream, mCommunicator);");
                        _builder.newLineIfNotEmpty();
                      } else {
                        _builder.append("\t\t");
        ...
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("mCommunicator->call(this);");
        _builder.newLine();
        _builder.append("\t\t");
        ...
        _builder.newLine();
        _builder.append("\t");
        _builder.append("void handleResult(::mora::InMethodResponse& response) {");
        _builder.newLine();
        {
          ...
          if (_isVoid_1) {
          ...
          } else {
            {
              ...
              if (_isPrim_1) {
                ...
                _builder.newLineIfNotEmpty();
                _builder.append("\t\t");
                _builder.append("response.stream() >> _result;");
                _builder.newLine();
              } else {
                ...
                if (_isEnum_1) {
                  ...
                  _builder.append("(response.stream());");
                  _builder.newLineIfNotEmpty();
                } else {
                  ...
                  if (_isProxy_1) {
                    ...
                    _builder.append("(response.stream(), mCommunicator);");
                    _builder.newLineIfNotEmpty();
                  } else {
                    _builder.append("\t\t");
  ...
  public CharSequence AdapterHeader(final Interface iface) {
    ...
    _builder.append(_adapterName);
    _builder.append(" : public ::mora::MoraAdapter<");
    String _iFaceName = this._cppTypeUtil.getIFaceName(iface);
    _builder.append(_iFaceName);
    _builder.append("> {");
    _builder.newLineIfNotEmpty();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("static ::mora::IMoraAdapterPtr createAdapter(::mora::Communicator* communicator, ");
    String _cppTypeName_1 = this._cppTypeUtil.cppTypeName(iface);
    _builder.append(_cppTypeName_1, "\t");
    _builder.append(" iface, const std::string& identifier);");
    _builder.newLineIfNotEmpty();
  ...
  public CharSequence adapterImpl(final Interface i) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append(":\t::mora::MoraAdapter<");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("::mora::IMoraAdapterPtr ");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("return communicator->registerAdapter(::mora::IMoraAdapterPtr(new ");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("::mora::IMoraAdapterPtr adapter = communicator->getAdapter(value);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("if (!adapter){");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("adapter = createAdapter(communicator, value, communicator->createRandomIdentifier());");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
